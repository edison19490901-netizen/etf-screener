...
ETF Screener 是一个实时 ETF 监控面板，跟踪 **18 只精选 ETF**，提供折溢价率、PE 分位、K 线图（含 Bollinger Bands）、费用对比、1Y 最高/最低价网格（斐波那契 0.25/0.382/0.5/0.618/0.75，6区）等指标。采用 **双模式数据刷新**架构，日常查看 ~3 秒，全量刷新 ~130 秒。
